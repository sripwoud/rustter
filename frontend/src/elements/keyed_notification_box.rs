...
// borrowed props (with lifetime annotation)
// https://dioxuslabs.com/learn/0.4/reference/component_props#borrowed-props
...
pub fn KeyedNotificationsBox<'a>(cx: Scope<'a, KeyedNotificationsProps<'a>>) -> Element {
